...
class reversedIchiV1(IStrategy):
    """

   Inspired by this strategy, but with reverses entry/exit options
        https://github.com/davidzr/freqtrade-strategies/blob/main/strategies/ichiV1/ichiV1.py
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['fast_under_slow'] = dataframe['trend_close_5m'] < dataframe[self.sell_params['sell_trend_indicator']]
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(dataframe['fast_under_slow'])
        conditions.append(dataframe['trend_close_5m'] > dataframe['trend_close_5m'].shift(1))
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Trends magnitude
        conditions.append(dataframe['fan_magnitude_gain'].rolling(2).max() >= self.buy_params['buy_min_fan_magnitude_gain'])
        conditions.append(dataframe['fan_magnitude_gain'] < dataframe['fan_magnitude_gain'].shift(1) )
